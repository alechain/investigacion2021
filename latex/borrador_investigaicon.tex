...
La muestra elegida de este pool de cortes transversales queda reducida a los jefes/as de hogar, asumiendo que la familia que conforma el hogar influye en los retornos netos de la migración (Mincer 1977) y el análisis de los migrantes de manera individual no permitiría contemplar dicha complejidad. Por otro lado, para este análisis no se consideran a los migrantes que tienen como región de destino y origen a la misma región ni tampoco a los migrantes internacionales.
...
\item Ocupado baja calificación y ocupado de alta calificación: estas variables binarias son del tipo categórica y representan a tres categorías, en donde el grupo base esta representado por las personas inactivas, desocupadas o con trabajos de baja calificación.
