...
cluster_exp1<- glm(inmigrante ~ hombre + edad + edad2  + medio + alto ,data = cluster1_expulsion,family = "binomial")
...
cluster_exp2<- glm(inmigrante ~ hombre + edad + edad2  + medio + alto ,data = cluster2_expulsion,family = "binomial")
...
cluster_exp3<- glm(inmigrante ~ hombre + edad + edad2  + medio + alto ,data = cluster3_expulsion,family = "binomial")
